...
public class LightsSubsystem extends SubsystemBase {
    ...
    private final SolidColor solidColorControl = new SolidColor(0, LightsConstants.numLEDs).withColor(currentColor);
    ...
    public static final class Colors {
        ...
        public static final RGBWColor[] allColors = new RGBWColor[]{Colors.WHITE, Colors.RED, Colors.YELLOW, Colors.ORANGE, Colors.GREEN, Colors.CYAN, Colors.BLUE, Colors.PURPLE, Colors.MAGENTA, Colors.PINK, Colors.AQUAMARINE};
    }
...
//        );
    ...
    private void updateFade() {
        ...
        candle.setControl(solidColorControl.withColor(currentColor.scaleBrightness(blinkOff ? 0.125 : 1)));
