...
public class FieldConstants {
    ...
    public enum GameElement {
        ...
        poop(new Pose2d(1, 0, Rotation2d.fromDegrees(0)), false, false);
        ...
        GameElement(Branches branches, boolean isBlue) {
            if (branches == null) throw new IllegalArgumentException("Branches cannot be null for reef elements.");
        ...
        public Pose2d getLeftBranch() {
            if (!hasBranches()) throw new UnsupportedOperationException("game element does not have branches");
